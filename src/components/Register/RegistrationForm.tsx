...
const HOARegistrationForm: React.FC = () => {
  ...
  }, [form.gender, form.sportCategory]);
  ...
  const validateImageFile = (file?: File) => {
    ...
    if (!ALLOWED_IMG.includes(file.type))
      return { ok: false, msg: "Only JPG/PNG/WebP allowed." };
    if (file.size > MAX_IMG_MB * 1024 * 1024)
      return { ok: false, msg: `Max ${MAX_IMG_MB} MB.` };
    return { ok: true, msg: "" };
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!form.dob) newErrors.dob = "Date of birth is required.";
      ...
      newErrors.dob = "Athlete must be at least 5 years old.";
    if (!form.gender) newErrors.gender = "Please select gender.";
    if (!form.permanentAddress.trim())
      newErrors.permanentAddress = "Permanent Address is required.";
    if (!form.tempAddress.trim())
      newErrors.tempAddress = "Temporary Addresss is required.";
    if (!form.idMark.trim())
      newErrors.idMark = "Identification Mark is required.";

    if (!isMobile10(digits))
    ...
    if (!form.sportId.id)
      newErrors.sportId = "Select at least one sport category.";
    if (form.sportId.id && form.categoryId.length === 0)
      newErrors.categoryId = "Select at least one Events.";
    ...
    if (!form.regCategory.trim())
      newErrors.regCategory = "Registration Category is required.";
    // --- Required files ---
    ...
    achievementLevels.forEach((level) => {
      ...
      if (level.textKey !== "otherAch") {
        if (!textValue.trim())
          newErrors[level.textKey] = `${level.name} description is required.`;
        if (!fileValue)
          newErrors[level.fileKey] = `${level.name} file is required.`;
      }
    });
    ...
    <div className="form-container" ref={formTopRef}>
      ...
      <div className="photo-upload-section">
        ...
        <input
          ...
          onChange={(e) =>
            handleFileUpload(e, setPhotoUrl, setPassportPhotoName)
          }
          aria-invalid={!!errors.passportPhoto}
          aria-describedby={
            errors.passportPhoto ? "passportPhoto-error" : undefined
          }
        />
        {passportPhotoName && (
          <div className="id-file-name">{passportPhotoName}</div>
        )}
        {errors.passportPhoto && (
          <div id="passportPhoto-error" className="error-text">
            {errors.passportPhoto}
          </div>
        )}
      </div>
      ...
      `}
        ...
        <div className="field mb-4">
          ...
          ${
            ...
            aria-describedby={
              errors.fathersName ? "fathersName-error" : undefined
            }
          />
          {errors.fathersName && (
        ...
        <div className="field mb-4">
          ...
          ${
            ...
            aria-describedby={
              errors.mothersName ? "mothersName-error" : undefined
            }
          />
          {errors.mothersName && (
      ...
      ${
        ...
        <div className="field">
          ...
          {errors.gender && (
            <div id="gender-error" className="error-text">
              {errors.gender}
            </div>
          )}
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-1/2 border rounded-lg p-4 shadow-sm">
            ...
            <input
              ...
              className="hidden"
              onChange={(e) =>
                handleFileUpload(e, setAadharFrontUrl, setAadharFrontName)
              }
            />
          ...
          <div className="w-full md:w-1/2 border rounded-lg p-4 shadow-sm">
            ...
            <input
              ...
              className="hidden"
              onChange={(e) =>
                handleFileUpload(e, setAadharBackUrl, setAadharBackName)
              }
            />
            <div className="flex items-center justify-between text-sm">
              <div
      ...
      ${
        errors.permanentAddress
          ...
          : "border-gray-300 focus:ring-2 focus:ring-orange-400"
            ...
            aria-describedby={
              errors.permanentAddress ? "permanentAddress-error" : undefined
            }
          />
          {errors.permanentAddress && (
            <div
              id="permanentAddress-error"
      ...
      ${
        errors.tempAddress
          ...
          : "border-gray-300 focus:ring-2 focus:ring-orange-400"
            ...
            aria-describedby={
              errors.tempAddress ? "tempAddress-error" : undefined
            }
          />
          {errors.tempAddress && (
        ...
        <div className="inline">
          <div className="field">
            ...
            />
            {errors.mobile && (
              <div id="mobile-error" className="error-text">
                {errors.mobile}
              </div>
            )}
          </div>
      ...
      ${
        ...
        <div className="field mb-4">
          <label className="block mb-1 font-medium">
            Height at time of registration (in cm)
      ...
      ${
          ...
          <div className="radio-group">
            <label className="radio-label">
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, regCategory: e.target.value as "Regular" })
                }
              />
              Regular
            </label>
            <label className="radio-label">
              <input
                ...
                onChange={(e) =>
                  setForm({
                    ...form,
                    regCategory: e.target.value as "Para Athlete",
                  })
                }
              />
              Para Athlete
        ...
        <div className="field">
          ...
          <input
            ...
            onBlur={() =>
              touch("username", !!form.username.trim(), "Username is required.")
            }
            type="text"
            required
        ...
        <div className="signature-wrap">
          ...
          <input
            ...
            style={{ display: "none" }}
            onChange={(e) =>
              handleFileUpload(e, setSignatureUrl, setSignatureName)
            }
          />
          <div className="id-actions" style={{ justifyContent: "center" }}>
            <div
              className="id-file-name"
              title={signatureName || "No file chosen"}
            >
          ...
          {errors.signature && (
            <div className="error-text">{errors.signature}</div>
          )}
        </div>
