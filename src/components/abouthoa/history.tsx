    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-sky-200 to-sky-200 px-6 py-12">
      ...
      <div className="max-w-5xl w-full bg-white rounded-2xl shadow-lg p-8 md:p-12">
        ...
        <section className="text-gray-700 text-base md:text-lg leading-relaxed space-y-5">
          <p>
            The <strong>Haryana Olympic Association (HOA)</strong> is an autonomous
            sports body affiliated with the Indian Olympic Association in the
            state of Haryana, India. Founded in 1966, the HOA is the apex sports
            body in the State of Haryana which is responsible for governing all
            Olympic and Non-Olympic State Sports Associations in the State of
            Haryana.
          </p>

          <p>
            HOA is dedicated to promoting sports development and nurturing
            athletic talent in the state and works tirelessly to identify, train,
            and support athletes, coaches, and sports officials, enabling them to
          ...
          <p>
            HOA has constituted various committees for <strong>Athlete Welfare & Governance</strong> 
