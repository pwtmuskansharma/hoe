...
const sportsData = [
  ...
  { name: 'FENCING', img: '/images/sports-images/FENCING.webp', icon: '/images/icons/FENCING.png' },
  { name: 'NETBALL', img: '/images/sports-images/NETBALL.webp', icon: '/images/icons/NETBALL.png' },
  { name: 'TRAIATHLON', img: '/images/sports-images/TRAIATHLON.webp', icon: '/images/icons/TRAIATHLON.png' },
  { name: 'YOGASANA', img: '/images/sports-images/YOGASANA.webp', icon: '/images/icons/YOGASANA.png' },
  { name: 'WATERPOLO', img: '/images/sports-images/WATERPOLO.webp', icon: '/images/icons/WATERPOLO.png' },
  { name: 'KAYAKING & CANOEING', img: '/images/sports-images/KAYAKING.webp', icon: '/images/icons/KAYAKING.png' },
  { name: 'KARATE', img: '/images/sports-images/KARATE.webp', icon: '/images/icons/KARATE.png' },
];
